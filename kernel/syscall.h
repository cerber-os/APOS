...
#define		SVC_KILL_THREAD		3
#define		SVC_SUSPEND_THREAD	4
...
void SVC_OSKillThread	(Thread*)		__attribute__((naked));
void SVC_OSKillSelf	(void);
void SVC_OSSuspendThread(Thread*, int32_t)	__attribute__((naked));
